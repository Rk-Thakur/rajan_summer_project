...
class createfixtures extends StatelessWidget {
  final fixturename = TextEditingController();
                  ...
                  InkWell(
                    onTap: () async {
                      ...
                      if (_form.currentState!.validate()) {
                        final response =
                            await ref.read(crudProvider).addfixture(
                                  fixture_name: fixturename.text.trim(),
                                  image: db.image!,
                                );
                        if (response == 'success') {
